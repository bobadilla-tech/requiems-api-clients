...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.IpInfoApi(api_client)

    try:
        # Get IP Info (Caller IP)
        api_response = api_instance.v1_networking_ip_get()
        print("The response of IpInfoApi->v1_networking_ip_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IpInfoApi->v1_networking_ip_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get IP Info for IP
        api_response = api_instance.v1_networking_ip_ip_get(ip)
        print("The response of IpInfoApi->v1_networking_ip_ip_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IpInfoApi->v1_networking_ip_ip_get: %s\n" % e)
```
