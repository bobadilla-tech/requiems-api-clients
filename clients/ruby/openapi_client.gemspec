...
Gem::Specification.new do |s|
  ...
  s.summary     = "Requiems API Ruby Gem"
  s.description = "Unified access to enterprise-grade APIs — email validation, text utilities, and more. Authenticate with the `requiems-api-key` header."
  s.license     = "Unlicense"
