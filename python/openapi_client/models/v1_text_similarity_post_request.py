...
class V1TextSimilarityPostRequest(BaseModel):
    """
    V1TextSimilarityPostRequest
    """ # noqa: E501
    text1: StrictStr = Field(description="The first text to compare.")
    text2: StrictStr = Field(description="The second text to compare.")
    __properties: ClassVar[List[str]] = ["text1", "text2"]
