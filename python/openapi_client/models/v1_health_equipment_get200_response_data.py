...
class V1HealthEquipmentGet200ResponseData(BaseModel):
    """
    V1HealthEquipmentGet200ResponseData
    """ # noqa: E501
    items: Optional[List[Any]] = Field(default=None, description="Sorted list of all distinct equipment names")
    total: Optional[StrictInt] = Field(default=None, description="Total number of distinct equipment types")
