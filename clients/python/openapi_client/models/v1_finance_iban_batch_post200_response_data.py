...
class V1FinanceIbanBatchPost200ResponseData(BaseModel):
    """
    V1FinanceIbanBatchPost200ResponseData
    """ # noqa: E501
    results: Optional[List[Any]] = Field(default=None, description="Validation result for each number in the same order as the input. Each item has the same fields as the single validate endpoint.")
    total: Optional[StrictInt] = Field(default=None, description="Number of results returned. Matches the length of the input array.")
