# Org.OpenAPITools.Model.V1PlacesGeocodeGet200ResponseData
...
**Lat** | **decimal** | Latitude of the matched location | [optional] 
**Lon** | **decimal** | Longitude of the matched location | [optional] 
