...
class V1EntertainmentSudokuBatchPostRequest(BaseModel):
    """
    V1EntertainmentSudokuBatchPostRequest
    """ # noqa: E501
    puzzles: List[Any] = Field(description="Array of difficulty levels to generate (min: 1, max: 20). Each must be one of: easy, medium, hard.")
    __properties: ClassVar[List[str]] = ["puzzles"]
