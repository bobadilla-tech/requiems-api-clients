...
class V1EntertainmentChuckNorrisGet200ResponseData(BaseModel):
    """
    V1EntertainmentChuckNorrisGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique fact identifier in the format cn_<index> (e.g. cn_0, cn_7)")
    fact: Optional[StrictStr] = Field(default=None, description="The Chuck Norris fact text")
    __properties: ClassVar[List[str]] = ["id", "fact"]
