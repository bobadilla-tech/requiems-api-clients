...
class V1TechnologyMarkdownPostRequest(BaseModel):
    """
    V1TechnologyMarkdownPostRequest
    """ # noqa: E501
    markdown: StrictStr = Field(description="The Markdown text to convert.")
    sanitize: Optional[StrictBool] = Field(default=None, description="When true, sanitizes the HTML output to remove unsafe tags and attributes.")
    __properties: ClassVar[List[str]] = ["markdown", "sanitize"]
