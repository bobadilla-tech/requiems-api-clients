...
class V1NetworkingDisposableBatchPost200ResponseData(BaseModel):
    """
    V1NetworkingDisposableBatchPost200ResponseData
    """ # noqa: E501
    results: Optional[List[Any]] = Field(default=None, description="Array of check results for each email")
    total: Optional[StrictInt] = Field(default=None, description="Total number of emails checked")
