...
class V1NetworkingDisposableDomainDomainGet200ResponseData(BaseModel):
    """
    V1NetworkingDisposableDomainDomainGet200ResponseData
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="The domain that was checked")
    is_disposable: Optional[StrictBool] = Field(default=None, description="Whether the domain is in the disposable blocklist")
    __properties: ClassVar[List[str]] = ["domain", "is_disposable"]
