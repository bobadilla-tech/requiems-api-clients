...
class V1NetworkingDisposableDomainsGet200ResponseData(BaseModel):
    """
    V1NetworkingDisposableDomainsGet200ResponseData
    """ # noqa: E501
    domains: Optional[List[Any]] = Field(default=None, description="Array of domain names")
    total: Optional[StrictInt] = Field(default=None, description="Total number of domains in blocklist")
    ...
    has_more: Optional[StrictBool] = Field(default=None, description="Whether there are more pages available")
    __properties: ClassVar[List[str]] = ["domains", "total", "page", "per_page", "has_more"]
