...
class V1TextNormalizeBatchPost200ResponseData(BaseModel):
    """
    V1TextNormalizeBatchPost200ResponseData
    """ # noqa: E501
    results: Optional[List[Any]] = Field(default=None, description="One normalization result per input email, in order")
    total: Optional[StrictInt] = Field(default=None, description="Number of emails in the batch (same as results length)")
