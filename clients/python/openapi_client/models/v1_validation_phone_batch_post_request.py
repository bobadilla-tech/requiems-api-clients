...
class V1ValidationPhoneBatchPostRequest(BaseModel):
    """
    V1ValidationPhoneBatchPostRequest
    """ # noqa: E501
    numbers: List[Any] = Field(description="Array of phone numbers to validate (min: 1, max: 50). Each must include the country calling code.")
