...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public sealed class TimezoneApiTests : ApiTestsBase
    {
        ...
        public async Task V1PlacesTimezoneGetAsyncTest()
        {
            Client.Option<string> lat = default!;
            Client.Option<string> lon = default!;
            Client.Option<string> city = default!;
            var response = await _instance.V1PlacesTimezoneGetAsync(lat, lon, city);
            var model = response.Ok();
            Assert.IsType<V1PlacesTimezoneGet200Response>(model);
        }
    }
}
