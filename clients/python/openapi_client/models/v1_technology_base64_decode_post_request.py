...
class V1TechnologyBase64DecodePostRequest(BaseModel):
    """
    V1TechnologyBase64DecodePostRequest
    """ # noqa: E501
    value: StrictStr = Field(description="The Base64-encoded string to decode")
    variant: Optional[StrictStr] = Field(default=None, description="Encoding variant: standard (default) or url (URL-safe base64url)")
    __properties: ClassVar[List[str]] = ["value", "variant"]
