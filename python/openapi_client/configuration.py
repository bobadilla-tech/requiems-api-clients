...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "requiems-api-key": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = openapi_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.requiems.xyz" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'requiems-api-key' in self.api_key:
            auth['requiems-api-key'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'requiems-api-key',
