# Org.OpenAPITools.Model.V1PlacesWorkingDaysGet200ResponseData

## Properties

| Name            | Type       | Description                                                                               | Notes      |
| --------------- | ---------- | ----------------------------------------------------------------------------------------- | ---------- |
| **WorkingDays** | **int**    | Number of working days between the two dates (excluding weekends and optionally holidays) | [optional] |
