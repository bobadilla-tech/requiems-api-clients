...
class V1EntertainmentEmojiSearchGet200ResponseData(BaseModel):
    """
    V1EntertainmentEmojiSearchGet200ResponseData
    """ # noqa: E501
    items: Optional[List[Any]] = Field(default=None, description="List of matching emoji objects")
    total: Optional[StrictInt] = Field(default=None, description="Total number of matches")
