...
class V1FinanceCommoditiesCommodityGet200Response(BaseModel):
    """
    V1FinanceCommoditiesCommodityGet200Response
    """ # noqa: E501
    data: Optional[V1FinanceCommoditiesCommodityGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V1FinanceCommoditiesCommodityGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
