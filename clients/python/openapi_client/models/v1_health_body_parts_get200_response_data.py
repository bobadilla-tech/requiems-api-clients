...
class V1HealthBodyPartsGet200ResponseData(BaseModel):
    """
    V1HealthBodyPartsGet200ResponseData
    """ # noqa: E501
    items: Optional[List[Any]] = Field(default=None, description="Sorted list of all distinct body part names")
    total: Optional[StrictInt] = Field(default=None, description="Total number of distinct body parts")
