...
// checks if the V1PlacesTimezoneGet200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PlacesTimezoneGet200ResponseData{}

// V1PlacesTimezoneGet200ResponseData struct for V1PlacesTimezoneGet200ResponseData
type V1PlacesTimezoneGet200ResponseData struct {
...
func NewV1PlacesTimezoneGet200ResponseData() *V1PlacesTimezoneGet200ResponseData {
	this := V1PlacesTimezoneGet200ResponseData{}
	return &this
}
...
func (o V1PlacesTimezoneGet200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o V1PlacesTimezoneGet200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableV1PlacesTimezoneGet200ResponseData struct {
	value *V1PlacesTimezoneGet200ResponseData
	isSet bool
}

func (v NullableV1PlacesTimezoneGet200ResponseData) Get() *V1PlacesTimezoneGet200ResponseData {
	return v.value
}

func (v *NullableV1PlacesTimezoneGet200ResponseData) Set(val *V1PlacesTimezoneGet200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PlacesTimezoneGet200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableV1PlacesTimezoneGet200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1PlacesTimezoneGet200ResponseData(val *V1PlacesTimezoneGet200ResponseData) *NullableV1PlacesTimezoneGet200ResponseData {
	return &NullableV1PlacesTimezoneGet200ResponseData{value: val, isSet: true}
}

func (v NullableV1PlacesTimezoneGet200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1PlacesTimezoneGet200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
