...
class V1HealthMusclesGet200ResponseData(BaseModel):
    """
    V1HealthMusclesGet200ResponseData
    """ # noqa: E501
    items: Optional[List[Any]] = Field(default=None, description="Sorted list of all distinct muscle names")
    total: Optional[StrictInt] = Field(default=None, description="Total number of distinct muscles")
