...
class V1NetworkingDisposableDomainsGet200Response(BaseModel):
    """
    V1NetworkingDisposableDomainsGet200Response
    """ # noqa: E501
    data: Optional[V1NetworkingDisposableDomainsGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V1NetworkingDisposableDomainsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
